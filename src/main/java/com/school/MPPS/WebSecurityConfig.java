...
//,"/Messstock/**","/Healthlog/**","/Mppsexam/**","/Scholarship/**","/Prevschool/**","/Gaurdian/**","/cmr/**","/Middaymeals/**","/esr/**","/Mppsstaff/**"
	...
	protected void configure(HttpSecurity http) throws Exception {
	  ...
	  http.authorizeRequests()
		...
		.antMatchers("/employee*","/Messstock/**","/Healthlog/**","/Mppsexam/**","/Scholarship/**","/Prevschool/**","/Gaurdian/**","/cmr/**","/Middaymeals/**","/esr/**","/Mppsstaff/**").access("hasRole('ROLE_EMPLOYEE') or hasRole('ROLE_ADMIN')")
